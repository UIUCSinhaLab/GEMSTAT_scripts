...
parser.add_argument("--S", metavar="S", type=float, default=1.0, help="value parameter.")
parser.add_argument("--target", metavar="TARGET", type=str, help="which factor to scale (empty scales all)")
